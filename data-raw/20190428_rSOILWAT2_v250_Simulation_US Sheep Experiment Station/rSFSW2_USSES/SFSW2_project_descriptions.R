...
fnames_in <- list(
  fmaster = "SWRuns_InputMaster_USSES_v11.csv",
  ...
  fdbWeather = file.path(project_paths[["dir_in"]], "dbWeatherData_USSES.sqlite3"),
...
sim_time <- list(
  ...
  future_yrs = list(
    c(delta = 0, DSfut_startyr = 0, DSfut_endyr = 0)
  )
)
