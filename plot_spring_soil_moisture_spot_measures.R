...
calibration <- read.csv('data/spot_measures/2015-05-07_soil_probe_calibration.csv')
calibration2 <- read.csv('data/spot_measures/2015-04-29_soil_probe_calibration.csv', skip = 8)
...
saveRDS(df, 'temp_data/spring_spot_measurements.RDS')
...
df <- readRDS('temp_data/spring_spot_measurements.RDS')
